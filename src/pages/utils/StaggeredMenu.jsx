...
.sm-scope .staggered-menu-header {
  ...
  padding: 2em; background: transparent; pointer-events: none; z-index: 100;
}
.sm-scope .staggered-menu-header > * { pointer-events: auto; }

/* LOGO */
.sm-scope .sm-logo-img { height: 32px; width: auto; object-fit: contain; filter: brightness(1.1); }
...
.sm-scope .sm-panel-item:hover {
  color: var(--sm-accent, #ff7b00); /* orange hover */
}
